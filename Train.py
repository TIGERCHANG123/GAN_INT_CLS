...
class train_one_epoch():
    def __init__(self, model, train_dataset, optimizers, metrics, noise_dim, gp):
        self.generator, self.discriminator, self.embedding = model
    ...
    def train_step(self, noise, images, text, text_generator):
        ...
        self.generator_optimizer.apply_gradients(zip(gradients_of_generator, self.generator.trainable_variables+self.embedding.trainable_variables))
